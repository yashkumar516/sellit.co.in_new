                ...
                <form action="" method="post" name="form">
                    <div class="questionborder">
                        ...
                        <div class="row pl-4" id="ynrow">
                            <div class="col-lg-5 col-6"><input id="toggle-yes" class="call" name="call" type="radio"
                                    value="yes" required><label for="toggle-yes">Yes</label></div>
                            <div class="col-lg-5 col-6"><input id="toggle-no" class="call" name="call" type="radio"
                                    value="no" required><label for="toggle-no">No</label></div>
                        </div>
                    ...
                    <div class="col-12 col-lg-12 mx-auto my-auto text-center p-5 img-responsive">
                        ...
                        <div class="row">
                            <div class="col-11 col-lg-12 mx-auto">
                                <form
                                    action="include/calculationtablet1.php?mid=<?php echo $mid ?>&&bid=<?php echo $bid ?>&&vid=<?php echo $vid ?>"
                                    method="POST">
                                    <div class="form-group">
...
$(document).ready(function() {
    $('.call').click(function() {
        ...
        if (call == "yes") {
            ...
            document.form.action = "include/calculationtablet1.php?mid=" + mid + "&&bid=" + bid +
                "&&vid=" + vid;
        }
    })
});
