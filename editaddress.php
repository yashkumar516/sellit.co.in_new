...
if (
    ...
    $id = $_REQUEST["id"];
    $uid = $_REQUEST["uid"];
    $fetchaddress = mysqli_fetch_assoc(
        mysqli_query($con, "SELECT * FROM `address1` WHERE `id` = '$id' ")
    );
}
if (isset($_POST["submit"])) {
    ...
    $insertquery = mysqli_query(
        $con,
        "UPDATE `address1` SET `location`='$location',`flatno`='$flatno',`landmark`='$landmark',`pincode`='$pincode',`city`='$city',
            ...
            <div class="row shadow py-5">
                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="nav col nav-pills col-lg-12 col-12" id="v-pills-tab" role="tablist"
                        ...
                        <a href="#tab3" class="nav-link square-pill mb-3  mr-3 col-lg-12 active" id="Ingredients-tab"
                            data-toggle="pill" role="tab" aria-controls="Ingredients-tab" aria-selected="false">
                            Saved Addresses
                        </a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-11 mx-auto add-form">
                                    <form action="" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="location"
                                                placeholder="Enter Address" value="<?php echo $fetchaddress[
                                     "location"
                                 ]; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="flatno"
                                                placeholder="Enter flat no/ office/ floor*" value="<?php echo $fetchaddress[
                                     "flatno"
                                 ]; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="landmark"
                                                placeholder="Land mark*" value="<?php echo $fetchaddress[
                                     "landmark"
                                 ]; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="pin" name="pincode" value="<?php echo $fetchaddress[
                                     "pincode"
                                 ]; ?>" placeholder="Pincode*" maxlength="6" onkeyup="validateInput(event)" required>
                                            <span id="error"></span>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" id="citdy"
                                                placeholder="City*" value="<?php echo $fetchaddress[
                                     "city"
                                 ]; ?>" readonly required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="state" id="statedy"
                                                placeholder="State*" value="<?php echo $fetchaddress[
                                     "state"
                                 ]; ?>" readonly required>
                                        </div>
                                        <p class="save-as">Save as</p>
                                        <?php if ($fetchaddress["addtype"] == "Home") { ?>
                                  ...
                                  $fetchaddress["addtype"] == "Other"
                                        ...
                                        <?php } ?>
                                        <div class="pt-3">
                                            <button type="submit" id="sibm" name="submit"
