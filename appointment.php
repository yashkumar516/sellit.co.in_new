...
if (isset($_REQUEST["enid"]) && isset($_REQUEST["uid"])) {
  ...
  $uid = $_REQUEST["uid"];
  $seleenq = mysqli_fetch_assoc(
    mysqli_query($con, "SELECT * FROM `enquiry` WHERE `id` = '$enquid' ")
  );
...
if (isset($_POST["appointment"])) {
  ...
  $insert = mysqli_query(
    $con,
    "UPDATE `address` SET `soon`='$soon',`choseday`='$chooseday',`day`='$date',`day1`='$day',`year`='$year',`time`='$time' WHERE `uid` = '$uid' AND `enquid` = '$enquid'"
  );
  if ($insert) {
    echo "<script>
              ...
              <div id="shi">
                ...
                <div class="row pt-3">
                  ...
                  <div class="col-lg-3 col-6">
                    <input id="toggle1" class="notrequired" name="day" type="radio" value="<?php echo date(
                                                                                              "d-m-y"
                                                                                            ); ?>"><label for="toggle1"><?php echo date(
                                                    "d l"
                                                  ); ?></label>
                  </div>
                  <div class="col-lg-3 col-6">
                    <input id="toggle2" class="notrequired" name="day" type="radio" value="<?php echo date(
                                                                                              "d-m-y",
                                                                                              $oneday
                                                                                            ); ?>"><label for="toggle2"><?php echo date(
                                                      "d l",
                                                      $oneday
                                                    ); ?></label>
                  </div>
                  <div class="col-lg-3 col-6">
                    <input id="toggle3" class="notrequired" name="day" type="radio" value="<?php echo date(
                                                                                              "d-m-y",
                                                                                              $twoday
                                                                                            ); ?>"><label for="toggle3"><?php echo date(
                                                      "d l",
                                                      $twoday
                                                    ); ?></label>
                  </div>
                ...
                <div class="row pt-3 label2">
                  <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <input id="toggle5" class="notrequired" name="time" type="radio"
                      value="10:00AM-12:00PM" required><label for="toggle5">10:00 AM - 12:00
                      PM</label>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <input id="toggle6" class="notrequired" name="time" type="radio"
                      value="12:00PM-02:00PM" required><label for="toggle6">12:00 PM - 02:00
                      PM</label>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <input id="toggle7" class="notrequired" name="time" type="radio"
                      value="02:00PM-04:00PM" required><label for="toggle7">02:00 PM - 04:00
                      PM</label>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <input id="toggle8" class="notrequired" name="time" type="radio"
                      value="04:00PM-06:00PM" required><label for="toggle8">04:00 PM - 06:00
                      PM</label>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <input id="toggle9" class="notrequired" name="time" type="radio"
                      value="06:00PM-08:00PM" required><label for="toggle9">06:00 PM - 08:00
                      PM</label>
                  </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-12 price-summary">
              <div class="card">
                ...
                <div class="text-center py-2">
                  <button type="submit" name="appointment" class="btn contin-btn">Get Paid <i
