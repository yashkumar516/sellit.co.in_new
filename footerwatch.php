...
<section class="top-selling" style="background-color: #fff;">
    <div class="container top-selling-div">
        ...
        <div class="owl-carousel owl-carousel-12 owl-theme col-12">
            <?php
            $queryBrand = mysqli_query($con, "SELECT * FROM `subcategory` WHERE `status` = 'active' AND `top` = 'active' AND `category_id` = '2' ");
  ...
  <div class="container mb-5"> -->
        <div class="owl-carousel owl-carousel-12 owl-theme col-12">
            ...
            ?>
                <div class="item my-3">
                    <a
                        href="watchsold.php?id=<?php echo $modelData['id'] ?>&&bid=<?php echo $modelData['subcategoryid'] ?>">
