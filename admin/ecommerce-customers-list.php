								...
								<div class="card-body">
									<div class="datatables-header-footer-wrapper">
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 750px;">
											...
											<tbody>
												<?php 
												  $customerquery = mysqli_query($con,"SELECT * FROM `user_detail`");
												...
												<tr>
													...
													<td>
												     <a href="delete_customer.php?id=<?php echo $arcustomer['id'] ?>" onclick="delete()"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
													</td>
													<td><a href="#"><strong><?php echo $arcustomer['displayname']  ?></strong></a></td>
													<td><?php echo $arcustomer['phone'] ?></td>
													<td><?php echo $arcustomer['email'] ?></td>
													<td>
													<?php 
													$cid = $arcustomer['id'];
													$checkstatus = $arcustomer['status'];
