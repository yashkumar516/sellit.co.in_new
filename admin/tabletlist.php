									...
									<div class="datatables-header-footer-wrapper">
										...
										<table class="table table-ecommerce-simple table-striped mb-0 " id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchproduct = mysqli_query($con,"SELECT * FROM `product` WHERE `categoryid` = '3'");
											...
											<!-- fetch category details end -->
												<tr>
													...
													<td>
														<a href="delete_tablet.php?id=<?php echo $arproduct['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_tablet.php?id=<?php echo $arproduct['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
...
swal({ title: "warning",
 ...
 type: "warning"}).then(confirm => {
   if (confirm) {
    window.location.href = 'change_tabletp_status.php?id='+id;
  }
});
