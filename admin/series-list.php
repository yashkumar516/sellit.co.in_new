                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a
                                             href="delete_childcategory.php?id=<?php echo $arch['id'] ?>&&bid=<?php echo $id ?>"><button
                                                 class="btn btn-danger">Delete</button></a>
                                         <a
                                             href="update_childcategory.php?id=<?php echo $arch['id'] ?>&&bid=<?php echo $id ?>">
                                             <button class="btn btn-success">Edit series</button></a>
                                     </td>
                                     <?php 
                                                     $brand = $arch['subcatid'];
