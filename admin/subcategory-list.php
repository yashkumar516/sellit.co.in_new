                     ...
                     <div class="datatables-header-footer-wrapper">
                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 ...
                                 <?php
												$fetchsub = mysqli_query($con,"SELECT * FROM `subcategory` WHERE `category_id` = '1'");
                                 ...
                                 <tr>
                                     ...
                                     <td width="13%">
                                         <a href="delete_subcategory.php?id=<?php echo $arsub['id'] ?>"><strong><i
                                                     class="fas fa-trash-alt mr-3"
                                                     style="font-size:20px;"></i></strong></a>
                                         <a href="update_subcategory.php?id=<?php echo $arsub['id'] ?>"><i
...
function changestatus(gid) {
    var id = gid;
    var url = 'change_subcategory_status.php?id=' + id;
...
function changetop(gid) {
    var id = gid;
    var url = 'change_subcategory_top.php?id=' + id;
    $(location).attr('href', url);
}
 </script>
