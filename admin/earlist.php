                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0 " id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a href="delete_ear.php?id=<?php echo $arproduct['id'] ?>"><strong><i
                                                     class="fas fa-trash-alt mr-3"
                                                     style="font-size:20px;"></i></strong></a>
                                         <a href="update_ear.php?id=<?php echo $arproduct['id'] ?>"><i
 ...
 <script src="js/customBfrtip.js" data-order=7></script>
