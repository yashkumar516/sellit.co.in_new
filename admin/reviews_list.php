								...
								<div class="card-body">
									<div class="datatables-header-footer-wrapper">
												...
												<div class="col-12 col-lg-auto pl-lg-1">
													<div class="search search-style-1 search-style-1-lg mx-lg-auto">
														<div class="input-group">
															<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Review">
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 750px;">
											...
											<tbody>
												<?php 
												  $reviequery = mysqli_query($con,"SELECT * FROM `reviews`");
												...
												<tr>
													...
													<td>
												     <a href="delete_review.php?id=<?php echo $arreview['id'] ?>" onclick="delete()"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
													</td>
...
<script>
	...
	{
		var id = gid;
		var url = 'change_review_status.php?id='+id;
