                         ...
                         <div class="form-row">
                             <div class="form-group col mb-3">
                                 ...
                                 <select class="form-control form-control-modern" name="orderStatus" required>
                                     <option value="<?php echo $orderquery['status'] ?>" selected>
                                         <?php echo $orderquery['status'] ?></option>
                                 ...
                                 <div class="date-time-field">
                                     <div class="date">
                                         <input type="text" class="form-control form-control-modern" name="orderDate"
                                             value="<?php echo date('d/m/y',strtotime($orderquery['modify_date'])) ?>"
                                             required data-plugin-datepicker
                                     ...
                                     <div class="time">
                                         ...
                                         <input type="text" class="form-control form-control-modern text-center"
                                             name="orderTimeHour"
                                             value="<?php echo date('h',strtotime($orderquery['modify_date'])) ?>"
                                             required />
                                         <span class="px-2">:</span>
                                         <input type="text" class="form-control form-control-modern text-center"
                                             name="orderTimeMin"
                                             value="<?php echo date('i',strtotime($orderquery['modify_date'])) ?>"
                                             required />
                                     </div>
                                 </div>
                             </div>
                     ...
                     <div class="card-body">
                         <div class="row">
                             <div class="col-xl-auto mr-xl-5 pr-xl-5 mb-4 mb-xl-0">
                                 ...
                                 <a href="mailto:<?php echo $billingquery['email'] ?>">
                                     <li><?php echo $billingquery['email'] ?></li>
                                 </a>
                             ...
                             <div class="col-xl-auto pl-xl-5">
                                 <h3 class="font-weight-bold text-color-dark text-4 line-height-1 mt-0 mb-3">SHIPPING
                                 </h3>
                                 <?php
                                 ...
                                 <strong class="d-block text-color-dark">Email address:</strong>
                                 <a
                                     href="mailto:<?php echo $shippingquery['email'] ?>"><?php echo $shippingquery['email'] ?></a>
                                 <strong class="d-block text-color-dark mt-3">Phone:</strong>
                                 <a href="tel:+5551234"
                                     class="text-color-dark"><?php echo $shippingquery['phone'] ?></a>
                                 <?php
												}
												else{
												?>
                         ...
                         <div class="table-responsive">
                             <table
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         <td class="pl-4"><a
                                                 href="ecommerce-products-form.html"><strong><?php echo $arod['id'] ?></strong></a>
                                         </td>
