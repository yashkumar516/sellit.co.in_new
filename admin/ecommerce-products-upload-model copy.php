...
<section role="main" class="content-body content-body-modern mt-0">
    ...
    <div class="row action-buttons my-3">
        <div class="col-12 col-md-auto   ">
            ...
            <a href="ecommerce-products-form.php" class="cancel-button btn btn-light btn-px-4 my-3 border font-weight-semibold text-color-dark text-3">Single
                Model</a>
        </div>
        <div class="col-12 col-md-auto px-0  ">
            <a href="#" class="cancel-button btn btn-primary btn-px-4 my-3 border font-weight-semibold text-color-dark text-3">Upload
                CSV</a>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3-5 col-xl-4-5">
                            <div class="form-group row align-items-end  py-2 text-lg-right ">
                                <div class=" col-12 float-right">
                                    <button class="btn btn-light  " onclick="downloadCSV(demoWithBrandCSV, 'sample.csv')">Sample CSV
                                    </button>
                                </div>
                            </div>
                            <form action="#" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group row align-items-center  py-5">
                                    ...
                                    <div class="col-lg-2 col-xl-3">
                                        <input type="submit" class="btn btn-primary" value="upload" name="uploadWithBrandCSV">
                                    </div>
                                </div>
                            </form>
                                ...
                                ?>
                                    ...
                                    <tr>
                                     ...
                                     <td><strong><?php echo $arproduct["vid"]; ?></strong></td> -->
                                        <!-- <td><?= $fetchbb["subcategory_name"] ?></td> -->
                                        <td class="text-capitalize">
                                            <?php echo $fetchbb["subcategory_name"]; ?>
                                        </td>

                                        <td><a href="#"><img src="img/<?php echo $fetchbb["subcategory_image"]; ?>" alt="img" width="100px"></a>
                                        ...
                                        <td><a href="#"><img src="img/<?php echo $selproduct["product_image"]; ?>" alt="img" width="100px"></a>
