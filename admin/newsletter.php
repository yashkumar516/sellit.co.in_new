                 ...
                 <div class="card-body">
                     <div class="datatables-header-footer-wrapper">
                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 <?php
												$userquery = mysqli_query($con,"SELECT * FROM `newsletter` ");
                                 ...
                                 <tr>
                                     ...
                                     <td><a
                                             href="ecommerce-orders-detail.php?id=<?php echo $aruser['id'] ?>"><strong><?php echo $aruser['id'] ?></strong></a>
                                     </td>
                                     <td>
                                         <a href="deletenewsletter.php?id=<?php echo $aruser['id'] ?>"
                                             title="delete"><strong><i class="fas fa-trash-alt mr-3"
                                                     style="font-size:20px;"></i></strong></a>
                                     </td>
                                     <td><?php echo $aruser['mobile']  ?></td>
                                     <td><?php echo date("y/m/d",strtotime($aruser['modify'])) ?></td>
                                 </tr>
                                 <?php
												}
												?>
 ...
 <script src="js/customBfrtip.js" data-order=3></script>
