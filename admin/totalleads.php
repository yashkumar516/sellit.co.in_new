                         ...
                         <div class="datatable-header">
                             <div class="row align-items-center mb-3">
                                 ...
                                 <div class="col-5 w-100">
                                     <div class="form-group float-right     mb-0 w-100" id="has-search"> <span class="fa fa-search form-control-feedback"></span> <input type="text" class="form-control" placeholder="Search"></div>
                                     ...
                                     <div class="d-inline-flex w-100  ">
                                         ...
                                         <button type="button" class="btn btn-primary w-100 px-1" id="excelButton"><i class="bx bx-download text-4 mr-2"></i>
                                             Excel
                                         </button>
                                         <button type="button" class="btn btn-primary w-100 px-1" id="pdfButton"><i class="bx bx-download text-4 mr-2"></i>
                                             PDF
                                         </button>
                                     </div>
                                 </div>
                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 640px;">
                             <thead>
                                 <tr>
                                     ...
                                     <th width="8%">Pickup Date</th>
                                     <th width="8%">Pickup Time</th>
                                     <th width="5%">Address</th>
                                     <th width="25%">Assign Lead</th>
                             ...
                             <tbody>
                                 <?php
                                    ...
                                    while ($arorder = mysqli_fetch_assoc($orderquery)) {
                                        $uid = $arorder['userid'];
                                        $enquid = $arorder['id'];
                                        $vendorId = $arorder['vendor_id'];
                                        $vendorName = "";
                                        if ($vendorId) {
                                            $vendorDetail = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `vendors` WHERE `id` = '$vendorId' "));
                                        ...
                                        if ($rowadd == 1) {
                                            ...
                                            $getpincode = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `address1` WHERE `id` = '$addressid' "));
                                            $pincode = $getpincode['pincode'];
                                            $city = $getpincode['city'];
                                    ...
                                    ?>
                                     <tr>
                                         ...
                                         <td><a href="moreinfo.php?id=<?php echo $arorder['id'] ?>" title="more info" class="text-primary"><?php echo $arorder['model_name'] ?></a></td>
                                        ...
                                        <div class="col-8" >
                                         <select class="search-term form-control" name="vendors" id="vendors">
                                             ...
                                             <?php if (isset($pincode)) {
                                                $selectvendors = mysqli_query($con, "SELECT * FROM vendors WHERE JSON_CONTAINS(pincode, '\"{$pincode}\"') AND status = 'active'");
                                                ...
                                                ?>
                                                     ...
                                                     <?php
                                                        ...
                                                        ?>
                                                         <option value="<?= $arvendors['id'] ?>" <?php if(isset($vendorId) && $vendorId == $arvendors['id'] ){ echo "selected"; } ?> ><?= $arvendors['name'] ?></option>;
                                                     <?php
                                                        }
                                                    } else {
                                                        ?>
                                             ...
                                             <?php
                                                   ...
                                                   echo '<option value="" selected>No vendor at this location</option>';
                                                }
                                            ?>
                                         </select>
                                         </div>
                                         <div class="col-4">
                                            <input type="hidden" name="enqid" value="<?= $enquid ?>">
