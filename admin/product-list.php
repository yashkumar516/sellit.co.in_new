                     ...
                     <div class="datatables-header-footer-wrapper">
                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0 " id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 ...
                                 <?php
												$fetchproduct = mysqli_query($con,"SELECT * FROM `product` WHERE `categoryid` = '1'");
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a href="delete_product.php?id=<?php echo $arproduct['id'] ?>"><strong><i
                                                     class="fas fa-trash-alt mr-3"
                                                     style="font-size:20px;"></i></strong></a>
                                         <a href="update_product.php?id=<?php echo $arproduct['id'] ?>"><i
                                                 class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
                                     </td>

                                     <td><a href="img/<?php echo $arproduct['product_image'] ?>"><img
                                                 src="img/<?php echo $arproduct['product_image'] ?>" alt="img"
                                                 width="100px"></a></td>
                                     <?php
                                     ...
                                     <!-- stock status start -->
                                     <!-- stock status end -->
                                     <td><?php echo date('Y/m/d',strtotime($arproduct['modify_date']))  ?></td>
                                     <td>
                                         <?php
                                                    $pid =$arproduct['id'];
 ...
 <script src="js/customBfrtip.js" data-order=8></script>
...
function changestatus(gid) {
    ...
    swal({
        ...
        if (confirm) {
            window.location.href = 'change_product_status.php?id=' + id;
        }
    });
...
function changetop(mid) {
    ...
    swal({
        ...
        if (confirm) {
            window.location.href = 'change_topmodel_status.php?id=' + id;
        }
    });
