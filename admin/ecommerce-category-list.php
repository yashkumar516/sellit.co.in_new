										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="category.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Category</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												...
												while($arcategory = mysqli_fetch_assoc($fetchcategory))
												{
											  ?>
											<!-- fetch category details end -->
												<tr>
													<td width="30"><input type="checkbox" name="checkboxRow1" class="checkbox-style-1 p-relative top-2" value="" /></td>
													<td><a href="#"><strong><?php echo $arcategory['id'] ?></strong></a></td>
													<td>
														<!-- <a href="delete_category.php?id=<php echo $arcategory['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a> -->
														<a href="update_category.php?id=<?php echo $arcategory['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
													<td><a href="#"><img src="img/<?php echo $arcategory['category_image'] ?>" alt="img" width="100px"></a></td>
													<td><?php echo $arcategory['category_name'] ?></td>
													<td><?php echo date('d/m/y',strtotime($arcategory['modify_date']))  ?></td>
													<td>
													<?php
													$cid = $arcategory['id'];
													$checkstatus = $arcategory['status'];
...
<!-- status script start here -->
   ...
   {
        var id = gid;
		var url = 'change_category_status.php?id='+id;
   ...
   {
	   var id = menuid ;
	   var url = 'change_category_menustatus.php?id='+id;
	   $(location).attr('href',url);
   }
   </script>
