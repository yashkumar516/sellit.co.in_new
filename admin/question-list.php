									...
									<div class="datatables-header-footer-wrapper">
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="questions.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Questions</a>
												</div>
											</div>
										</div>
										<table class="table table-ecommerce-simple table-striped mb-0 " id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchproduct = mysqli_query($con,"SELECT * FROM `questions`");
											...
											<!-- fetch category details end -->
												<tr>
													...
													<td>
														<a href="delete_question.php?id=<?php echo $arproduct['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_question.php?id=<?php echo $arproduct['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>                                                 
													<?php
...
<!-- status script start here -->
   <script>
    ...
    var id = gid;
      ...
      if (confirm) {
              window.location.href = 'change_question_status.php?id='+id;
          }
           });
