  ...
  $(function () {
    $(".card")
      ...
      .on("card:dismiss", function () {
        ...
        if (
          !!($this.parent("div").attr("class") || "").match(/col-(xs|sm|md|lg)/g) &&
...
(function (theme, $) {
  ...
  PluginChartCircular.prototype = {
    ...
    build: function () {
      ...
      shouldAnimate =
        $.isFunction($.fn["appear"]) && typeof $.browser !== "undefined" && !$.browser.mobile;
  ...
  $.extend(theme, {
    Nav: {
      ...
      build: function () {
        ...
        // Add Arrows
        $header
          .find(".dropdown-toggle:not(.notification-icon), .dropdown-submenu > a")
  ...
  GMapBuilder.prototype = {
    ...
    build: function () {
      ...
      if (!!window.SnazzyThemes) {
        ...
        $.each(window.SnazzyThemes, function (i, theme) {
          themeOpts.push(
            $('<option value="' + theme.id + '">' + theme.name + "</option>").data(
              "json",
              theme.json
            )
          );
    ...
    updateMapProperty: {
      ...
      maptype: function (value) {
        ...
        if (
          $.inArray(google.maps.MapTypeId[value.toUpperCase()], ["terrain", "roadmap"]) > -1 &&
          !!mapStyles
        ) {
      ...
      maptheme: function (value) {
        ...
        mapType =
          google.maps.MapTypeId[this.map.getMapTypeId() === "terrain" ? "TERRAIN" : "ROADMAP"];
        options = {};
        json = this.$wrapper
          .find('[data-builder-field="maptheme"]')
          .children("option")
    ...
    generate: function () {
      ...
      var zoomControl =
        this.$wrapper.find('[data-builder-field="zoomcontrol"] option:selected').val() !== "false";
      var mapTypeControl =
        this.$wrapper.find('[data-builder-field="maptypecontrol"] option:selected').val() !==
        "false";
      ...
      output = output
        ...
        .replace(
          /\{zoom\}/,
          this.$wrapper.find('[data-builder-field="zoomlevel"] option:selected').val()
        )
        .replace(/\{zoomControl\}/, zoomControl)
        .replace(
          /\{disableDoubleClickZoom\}/,
          this.$wrapper.find('[data-builder-field="clicktozoomcontrol"] option:selected').val() ===
            "false"
        )
        .replace(/\{mapTypeControl\}/, mapTypeControl)
        .replace(
          /\{scaleControl\}/,
          this.$wrapper.find('[data-builder-field="scalecontrol"] option:selected').val() !==
            "false"
        )
        .replace(
          /\{scrollwheel\}/,
          this.$wrapper.find('[data-builder-field="scrollwheelcontrol"] option:selected').val() !==
            "false"
        )
        .replace(
          /\{panControl\}/,
        ...
        .replace(
          /\{streetViewControl\}/,
          this.$wrapper.find('[data-builder-field="streetviewcontrol"] option:selected').val() !==
            "false"
        )
        .replace(
          /\{draggable\}/,
          this.$wrapper.find('[data-builder-field="draggablecontrol"] option:selected').val() !==
            "false"
        )
...
(function (theme, $) {
  ...
  PluginMultiSelect.defaults = {
    templates: {
      ...
      filter:
        '<div class="input-group"><span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search"></i></span></span><input class="form-control multiselect-search" type="text"></div>',
    },
  };
...
(function (theme, $) {
  ...
  PluginScrollable.updateBootstrapModal = function () {
    ...
    updateBoostrapModal =
      updateBoostrapModal && typeof $.fn.modal.Constructor.prototype !== "undefined";
    updateBoostrapModal =
      updateBoostrapModal && typeof $.fn.modal.Constructor.prototype.enforceFocus !== "undefined";
    ...
    build: function () {
      ...
      $items.each(function () {
        ...
        if (self.options.addIcons) {
          $el
            .find("> label")
            .prepend($("<i />").addClass("fas fa-plus"), $("<i />").addClass("fas fa-minus"));
        }
  ...
  var Skeleton = {
    ...
    buildSidebarLeft: function () {
      ...
      this.sidebars.left.isOpened =
        !$html.hasClass("sidebar-left-collapsed") || $html.hasClass("sidebar-left-opened");
    ...
    eventsSidebarLeft: function () {
      ...
      var close = function (e) {
        if (
          !!e &&
          !!e.target &&
          ($(e.target).closest(".sidebar-left").get(0) || !$(e.target).closest("html").get(0))
        ) {
          e.preventDefault();
          return false;
        } else {
      ...
      var isToggler = function (element) {
        return (
          ...
          $(element).parents().data("fire-event") === "sidebar-left-toggle"
        );
      };
