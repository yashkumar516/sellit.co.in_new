										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="ecommerce-coupons-form.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Coupon</a>
												</div>
												...
												<div class="col-12 col-lg-auto pl-lg-1">
													<div class="search search-style-1 search-style-1-lg mx-lg-auto">
														<div class="input-group">
															<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Coupan">
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 750px;">
											<thead>
												<tr>
													...
													<th width="12%"> Coupan Code</th>
													<th width="12%"> Coupan Type</th>
													<th width="13%"> Coupan Amount</th>
													<th width="13%"> Cart min Value</th>
											...
											<tbody>
												<?php
												 $detail = mysqli_query($con,"SELECT * FROM `coupan` ");
												 while ($cdetail = mysqli_fetch_assoc($detail))
												 {
												?>
												<tr>
													<td width="30"><input type="checkbox" name="checkboxRow1" class="checkbox-style-1 p-relative top-2" value="" /></td>
													<td><a href="ecommerce-coupons-form.html"><strong><?php echo $cdetail['id'] ?></strong></a></td>
													<td>
													<a href="delete_coupan.php?id=<?php echo $cdetail['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
													<a href="update_coupan.php?id=<?php echo $cdetail['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
													<td><a href="ecommerce-coupons-form.html"><strong><?php echo $cdetail['coupan_name'] ?></strong></a></td>
													<td><?php echo $cdetail['coupan_type'] ?></td>
													<td><?php echo $cdetail['coupan_value'] ?></td>
													<td><?php echo $cdetail['cart_min_value'] ?></td>
													<td><?php echo date('d/m/y',strtotime($cdetail['modify_date'])) ?></td>
														
													<td>
													<?php
                                                    $cid = $cdetail['id'];
													$checkstatus =$cdetail['status'];
...
<!-- status change script start -->
<script>
	   function changestatus(mid)
   {
	   var id = mid ;
	   var url = 'change_coupan_status.php?id='+id;
