...
if (isset($_POST["uploadWithSerieCSV"])) {
                            ...
                            <div class="row  px-3 pt-3">
                                <div class="col-5">
                                    <form action="#" enctype="multipart/form-data" method="POST"
                                        ...
                                        <button type="button" class="btn btn-primary w-100" onChange="uploadFile()"
                                            value="upload" name="uploadWithSerieCSV"
                                            onclick="submitCSVForm('uploadCSVSeriesForm','Series')"> <i
