 	...
 	<!-- end sidebar -->
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Vendors</h2>
									...
									<div class="datatables-header-footer-wrapper">
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="addvendor.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add vendor</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchsub = mysqli_query($con,"SELECT * FROM `vendors`");
											...
											<!-- fetch category details end -->
												<tr>
													...
													<td>
														<a href="delete_vendor.php?id=<?php echo $arsub['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_vendor.php?id=<?php echo $arsub['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
													<td><?php echo $arsub['pincode'] ?></td>
													<td><?php echo $arsub['name'] ?></td>
													<td><?php echo $arsub['email'] ?></td>
													<td><?php echo $arsub['mobileno'] ?></td>
                                                    <td><?php echo $arsub['alternateno'] ?></td>
                                                    <td><?php echo $arsub['presentadd'] ?></td>
													<td>
													<?php
													$sid = $arsub['id'];
...
<!-- status script start here -->
   ...
   {
        var id = gid;
		var url = 'change_vendor_status.php?id='+id;
