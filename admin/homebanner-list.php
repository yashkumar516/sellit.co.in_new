                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td width="23%">
                                         <a href="delete_homebanner.php?id=<?php echo $arbanner['id'] ?>"><strong><i
                                                     class="fas fa-trash-alt mr-3"
                                                     style="font-size:20px;"></i></strong></a>
                                         <a href="update_homebanner.php?id=<?php echo $arbanner['id'] ?>"><i
                                                 class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
                                     </td>
                                     <td><img src="img/<?php echo $arbanner['image'] ?>" width="100px" alt="">
                                     </td>
                                     <td><span
                                             class="d-none"><?php echo date('y/m/d',strtotime($arbanner['modify']))  ?></span>
                                         <?php echo date('F j, Y',strtotime($arbanner['modify']))  ?>
                                     </td>
                                     <td>
                                         <?php
                                                    $bid = $arbanner['id'];
 ...
 <script src="js/customBfrtip.js" data-order=4 data-orderType="desc"></script>
