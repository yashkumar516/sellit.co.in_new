			 ...
			 display: none !important;
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Shop Feature</h2>
									...
									<div class="datatables-header-footer-wrapper">
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="upload_shop_feature.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Feature</a>
												</div>
												<div class="col-8 col-lg-auto ml-auto mb-3 mb-lg-0">
													<div class="d-flex align-items-lg-center flex-column flex-lg-row">
														...
														<select class="form-control select-style-1 filter-by" name="filter-by">
															...
															<option value="3">Feature Name</option>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchfeature = mysqli_query($con,"SELECT * FROM `shop_feature`");
												while($arfeature = mysqli_fetch_assoc($fetchfeature))
												{
											  ?>
											<!-- fetch category details end -->
												<tr>
													<td width="30"><input type="checkbox" name="checkboxRow1" class="checkbox-style-1 p-relative top-2" value="" /></td>
													<td><a href="#"><strong><?php echo $arfeature['id'] ?></strong></a></td>
													<td>
														<a href="delete_shop_feature.php?id=<?php echo $arfeature['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_shop_feature.php?id=<?php echo $arfeature['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>
                                                    <td><?php echo $arfeature['feature_name'] ?></td>
                                                    <td><?php echo $arfeature['link'] ?></td>
													<td><?php echo date('d/m/y',strtotime($arfeature['last_modify']))  ?></td>
													<td>
													<?php
													$cid = $arfeature['id'];
													$checkstatus = $arfeature['status'];
...
<!-- status script start here -->
   ...
   {
        var id = gid;
		var url = 'change_shop_feature_status.php?id='+id;
