			 ...
			 display: none !important;
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Queries</h2>
										...
										<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 750px;">
											<thead>
												<tr>
                                                    ...
                                                    <th width="40%">messege</th>
												</tr>
											</thead>
											<tbody>
												<?php 
												  $customerquery = mysqli_query($con,"SELECT * FROM `query`");
												  while($arcustomer = mysqli_fetch_assoc($customerquery))
												  {
												
												?>
												<tr>
													<td width="30"><input type="checkbox" name="checkboxRow1" class="checkbox-style-1 p-relative top-2" value="" /></td>
													<td><a href="#"><strong><?php echo $arcustomer['id']  ?></strong></a></td>
													<td>
												     <a href="delete_query.php?id=<?php echo $arcustomer['id'] ?>" onclick="delete()"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
													</td>
													<td><a href="#"><strong><?php echo $arcustomer['name']  ?></strong></a></td>
													<td><?php echo $arcustomer['email'] ?></td>
                                                 
                                                    <td>
                                                        <textarea name="" readonly id="" cols="100" ><?php echo $arcustomer['messege'] ?></textarea>
                                                    </td>
												</tr>
												<?php 
												  }
...
<script>
	...
	{
		var id = gid;
		var url = 'change_customer_status.php?id='+id;
