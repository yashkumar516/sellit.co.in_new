                         ...
                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list"
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a href="delete_earbrand.php?id=<?php echo $arsub['id'] ?>"><strong><i
                                                     class="fas fa-trash-alt mr-3"
                                                     style="font-size:20px;"></i></strong></a>
                                         <a href="update_earbrand.php?id=<?php echo $arsub['id'] ?>"><i
 ...
 <script src="js/customBfrtip.js" data-order=6 data-order-type="asc"></script>
