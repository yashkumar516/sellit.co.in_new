	 ...
	 <!-- end sidebar -->
				...
				<section role="main" class="content-body content-body-modern mt-0">
					<header class="page-header page-header-left-inline-breadcrumb">
						<h2 class="font-weight-bold text-6">Varient</h2>
										...
										<div class="datatable-header">
											<div class="row align-items-center mb-3">
												<div class="col-12 col-lg-auto mb-3 mb-lg-0">
													<a href="varient.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Varient</a>
												</div>
										...
										<table class="table table-ecommerce-simple table-striped mb-0 " id="datatable-ecommerce-list" style="min-width: 550px;">
											<thead>
												<tr>
                                                    ...
                                                    <th width="9%">Varient Name</th>
                                                    <th width="9%">Upto Value</th>
											...
											<!-- fetch category details start -->
                                              <?php
												$fetchproduct = mysqli_query($con,"SELECT * FROM `varient`");
											...
											<!-- fetch category details end -->
												<tr>
													...
													<td>
														<a href="delete_varient.php?id=<?php echo $arproduct['id'] ?>"><strong><i class="fas fa-trash-alt mr-3" style="font-size:20px;"></i></strong></a>
														<a href="update_varient.php?id=<?php echo $arproduct['id'] ?>"><i class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
													</td>                                                 
													<?php
												   ...
												   ?>
													...
													?>
													<?php
													   $childcatname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `childcategory` WHERE `id` = '$childcategoryid' "));
													   if($childcatname == null)
													   {
												   ?>
												    <td>none</td>
													<?php
													 ...
													 {
													?>
													<td><?php echo $childcatname['childcategory'] ?></td>
													<?php
													}
													?>
                                                    <?php
                                                       $modelname = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM `product` WHERE `id` = '$mid' "));
                                                    ?>
													<td><?php echo $modelname['product_name'] ?></td>
...
<!-- status script start here -->
   <script>
    ...
    var id = gid;
      ...
      if (confirm) {
              window.location.href = 'change_varient_status.php?id='+id;
          }
           });
