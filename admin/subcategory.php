...
<section role="main" class="content-body content-body-modern mt-0">
    ...
    <!-- <div class="row action-buttons my-3">
        ...
        <div class="col-12 col-md-auto px-0  ">
            <a href="subcategory-upload.php"
                class="cancel-button btn btn-light btn-px-4 my-3 border font-weight-semibold text-color-dark text-3">Import
                CSV</a>
        </div>
    </div> -->
    <!-- start: page -->
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center">
                                    <div class="col">
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"> Brand
                                                Image(93*93 px)</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="file" class="form-control form-control-modern" name="Image"
                                                    value="" required />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <p class="card-big-info-desc">Add here the Brand description with all details and
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="form-group row align-items-center">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"> Brand
                                        Name</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="Name" value=""
                                            required />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 px-0">
                                <div class="form-group row align-items-center">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Call Not
                                        Recieve</label>
                                    <div class="col-lg-7 col-xl-8 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="callrecieve"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 ">
                                        <input type="text" class="form-control form-control-modern" name="below3"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 ">
                                        <input type="text" class="form-control form-control-modern" name="3to6"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="6to11"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="11above"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="touchscreen"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="largespots"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="multiplespots"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="minorspots"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="nospots"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="displayfade"
                                            placeholder="% Value" required>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern"
                                            name="multipleslines" placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="nolines"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="screencracked"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="damagescreen"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern"
                                            name="heavyscratches" placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="1-2scratches"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="noscratches"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="majorscratch"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="2scretch"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    <label class="col-12  control-label  mb-0">No scratches</label>
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="noscratch"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="heavydents"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="2dents"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="nodents"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern" name="crackedpanel"
                                            placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern"
                                            name="missingsidepanel" placeholder="% Value" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern"
                                            name="nodefectsideback" placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 px-0">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="bentcurved"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="card card-modern card-big-info">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    <label class="col-12  control-label mb-0">Loose screen (Gap in screen and
                                        body)</label>
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="gapinscreen"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="nobents"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern"
                                            name="originalcharger" placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12 pr-0">
                                        <input type="text" class="form-control form-control-modern"
                                            name="originalearphone" placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="boximei"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-12  pr-0">
                                        <input type="text" class="form-control form-control-modern" name="billimei"
                                            placeholder="% Value" required>
                                    </div>
                                </div>
