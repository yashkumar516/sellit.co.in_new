					...
					<!-- start: page -->
						<form  action="" method="post" enctype="multipart/form-data" >
							...
							<div class="row action-buttons">
								...
								<button type="submit" name="productss" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
