	                 ...
	                 <div class="card-body">
	                     <div class="datatables-header-footer-wrapper">
	                         ...
	                         <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list"
	                             ...
	                             <thead>
	                                 <tr>
	                                     <th width="1%"><input type="checkbox" name="select-all"
	                             ...
	                             <tbody>
	                                 ...
	                                 <tr>
	                                     <td width="10"><input type="checkbox" name="checkboxRow1"
	                                             class="checkbox-style-1 p-relative top-2" value="" /></td>
	                                     <td><a href="#"><strong><?php echo $arsub['id'] ?></strong></a></td>
	                                     <td>
	                                         <a href="delete_tablebrand.php?id=<?php echo $arsub['id'] ?>"><strong><i
	                                                     class="fas fa-trash-alt mr-3"
	                                                     style="font-size:20px;"></i></strong></a>
	                                         <a href="update_tablebrand.php?id=<?php echo $arsub['id'] ?>"><i
	                                                 class="fas fa-edit ml-1" style="font-size:20px;"></i></strong></a>
	                                         <?php
                                                        if($childcat >= 1){
														?>
	                                         <a href="series-list.php?id=<?php echo $arsub['id'] ?>"><button
	                                                 class="btn btn-warning ml-3">Update Series</button></a>
	                                         <?php
														}
														?>
	                                     </td>
	                                     ...
	                                     <td><a href="#"><img src="img/<?php echo $arsub['subcategory_image'] ?>" alt="img"
	                                                 width="100px"></a></td>
	                                     <td><?php echo date('Y/m/d',strtotime($arsub['modify_date']))  ?></td>
	                                     <td>
	                                         <?php
													$sid = $arsub['id'];
	 ...
	 <script src="js/customBfrtip.js" data-order=6></script>
