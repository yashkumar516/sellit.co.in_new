...
if (isset($_POST["submit"])) {
    ...
    move_uploaded_file(
        ...
        "admin/img/" . str_replace(" ", "_", $_FILES["image"]["name"])
    );
    $query = mysqli_query(
        $con,
        "UPDATE `enquiry` SET `modelimage` = '$deviceimg' WHERE `id` = '$enqid' "
    );
    if ($query) {
        echo "<script>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 uploadimage">
                    ...
                    <div class="row">
                        <div class="upload-btn-wrapper col-7 col-lg-6" for="myfile">
                            <button class="btn"><i class="fas fa-plus-circle"></i> <br>
                                <p class="">Click to Upload</p>
                                <input type="file" name="image" class="deviceimage" id="myfile" value="" />
                            </button>
                        </div>

                        <div class="upload-btn-wrapper col-4 col-lg-5 text-center d-none" id="imagepreview">
