...
$selectupto = mysqli_fetch_assoc(
    mysqli_query(
        $con,
        "SELECT * FROM `earpodequestions` WHERE `product_name` = '$mid' "
    )
);
?>
<div class="container-fluid" id="sold">
    ...
    <div class="row pb-5">
        <div class="col-12 col-lg-7 mx-auto">
            <div class="row h-10">
                <div class="col-4 col-lg-4 "><img src="admin/img/<?php echo $selectModel[
                    "product_image"
                ...
                <div class="col-8 col-lg-6 my-auto offset-lg-1">
                    ...
                    <?php if ($selectupto["uptovalue"] != null) { ?>
                    <h1 class="sp">Rs. <?php echo $selectupto[
                        "uptovalue"
                    ]; ?>/-</h1>
                    <?php } else { ?>
