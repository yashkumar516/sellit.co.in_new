...
$_PAGE_DATA1 = isset($_SESSION['mobileAgePage']) && count($_SESSION['mobileAgePage']) >0? $_SESSION['mobileAgePage']:$_SESSION["currentData"];

// print_r($_SESSION["mobileAgePage"]);
// echo "<br/>----------";
// print_r($_PAGE_DATA);
if (isset($_PAGE_DATA1['callin']) && isset($_PAGE_DATA1['screenin']) && isset($_PAGE_DATA1['bodyin']) && isset($_PAGE_DATA1['warin'])) {
  // Session variables are set, so retrieve them
  $callin = $_PAGE_DATA1['callin'];
  $screenin = $_PAGE_DATA1['screenin'];
  $bodyin = $_PAGE_DATA1['bodyin'];
  $warin = $_PAGE_DATA1['warin'];
  $call = $_PAGE_DATA1['call'];
  $screen = $_PAGE_DATA1['screen'];
  $body = $_PAGE_DATA1['body'];
  $war = $_PAGE_DATA1['war'];
  $params = $_PAGE_DATA1['params']; 
 
} 
 
$_PAGE_DATA = isset($_SESSION['functionalPage']) && count($_SESSION['functionalPage']) >0? $_SESSION['functionalPage']:$_SESSION["currentData"];
...
$mobage = isset($_PAGE_DATA['mobage'])? $_PAGE_DATA['mobage']:""; 
  ...
  $battery = isset($_PAGE_DATA['battery'])? $_PAGE_DATA['battery']:""; 
  ...
  $batteryin = isset($_PAGE_DATA['batteryin'])? $_PAGE_DATA['batteryin']:""; 
