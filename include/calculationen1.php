...
// mobile and code end
 ...
 if(isset($_SESSION['user'])){
	 ...
	 $age = "Above 11 Months";
      $gennorderr = "MOB".time();
 $insertenquiry = mysqli_query($con,"INSERT INTO `enquiry` (`genorderid`,`userid`,`catid`,`modelid`,`model_name`,`mimg`,`offerprice`,`switchof`,`warenty`,`age`)
  VALUES('$gennorderr','$user','$catid','$mid','$mobilename','$modelimg','$offerprice','$switchwat[1]','$warinwat[1]','$age')");
