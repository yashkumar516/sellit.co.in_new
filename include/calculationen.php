...
function GENERATELOGS_API($DATA,$BLOCK,$flag=0) {
        $file_name = "/var/log/aakarist/watchcalculation";
...
// mobile and code end
 ...
 if(isset($_SESSION['user'])){
  ...
  `speaker`,`wifi`,`battery`,`touchscreen`,`conditions`,`age`) VALUES('$gennorderr','$user','$catid','$mid','$mobilename','$modelimg','$offerprice',
...
//  end verify code
  ...
  $insertenquiry = mysqli_query($con,"INSERT INTO `enquiry` (`genorderid`,`userid`,`catid`,`modelid`,`model_name`,`mimg`,`offerprice`,
  `switchof`,`billimei`,`boximei`,`stap`,`charger`,`bluetooth`,`opticalheart`,`sidebutton`,`digitalcrown`,`charging_port`,
  `speaker`,`wifi`,`battery`,`touchscreen`,`conditions`,`age`) VALUES('$gennorderr','$uid','$catid','$mid','$mobilename','$modelimg','$offerprice',
  '$switchwat[1]','$billimeiwat[1]','$boximeiwat[1]','$strapwat[1]','$chargerwat[1]','$bluetoothwat[1]','$opticalwat[1]',
  '$buttonwat[1]','$dcwat[1]','$chargingwat[1]','$speakerwat[1]','$wifiwat[1]','$batterywat[1]','$touchfaultywat[1]','$conditionwat[1]',
  '$agewat[1]') ");
