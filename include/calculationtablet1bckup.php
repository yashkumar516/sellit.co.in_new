...
// mobile and code end
 ...
 `switchof`) VALUES('$gennorderr','$user','$catid','$mid','$mobilename','$modelimg','$offerprice',
 '$switchwat[1]') ");
 if($insertenquiry)
 { 
...
if($code == $_SESSION['otp']){
    ...
    $gennorderr = "MOB".time();
 $insertenquiry = mysqli_query($con,"INSERT INTO `enquiry` (`genorderid`,userid`,`catid`,`modelid`,`model_name`,`mimg`,`offerprice`,
	 `switchof`) VALUES('$gennorderr','$uid','$catid','$mid','$mobilename','$modelimg','$offerprice','$switchwat[1]') ");

    echo  $fg = "INSERT INTO `enquiry` (`genorderid`,userid`,`catid`,`modelid`,`model_name`,`mimg`,`offerprice`,
         `switchof`) VALUES('$gennorderr','$uid','$catid','$mid','$mobilename','$modelimg','$offerprice','$switchwat[1]') ";
