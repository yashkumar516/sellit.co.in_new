               ...
               <div class="tab-pane fade show active" id="tab3" role="tabpanel" aria-labelledby="Ingredients-tab">
                  <div class="row">
                     <div class="col-lg-11 mx-auto add-form">
                        <form  method="post">
                           <div class="form-group">
                              <input type="number" class="form-control" id="accountno" name="accountno" placeholder="Account No*" value="<?php echo $selectacountdetail['accountno'] ?>"  required>
                           </div>
                           <div class="form-group">
                              <input type="number" class="form-control" id="conaccountno"  name="conaccountno" placeholder="Confirm Account no*" value="<?php echo $selectacountdetail['confirmaccountno'] ?>" required>
                            <p class="conaccountno"></p>
                           </div>
                           <div class="form-group">
                              <input type="text" class="form-control" id="befname" name="benefiname" placeholder="Beneficiary Name*" value="<?php echo $selectacountdetail['beneficiarname'] ?>" required>
                           </div>
                           <div class="form-group">
               ...
               <div class="tab-pane fade show active" id="tab3" role="tabpanel" aria-labelledby="Ingredients-tab">
                  <div class="row">
                     <div class="col-lg-11 mx-auto add-form">
                        <form  method="post">
                           <div class="form-group">
                              <input type="number" class="form-control" id="accountno"  name="accountno" placeholder="Account No*"   required>
                           </div>
                           <div class="form-group">
                              <input type="number" class="form-control" id="conaccountno"  name="conaccountno" placeholder="Confirm Account no*"  required>
                              <p class="conaccountno"></p>
                           </div>
                           <div class="form-group">
                              <input type="text" class="form-control" id="befname" name="benefiname" placeholder="Beneficiary Name*"  required>
                           </div>
                           <div class="form-group">
        ...
        var accountno = $("#accountno").val();
         ...
         if(accountno != '' && ifscode != ''){
             $.ajax({
                 url: "bankverify.php",
                 method:'POST',
                 data:{accountno:accountno,ifscode:ifscode},
                 cache: false,
