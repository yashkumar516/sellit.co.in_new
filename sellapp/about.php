        ...
        <div class="col-lg-12 col-12  mx-auto card">
            <div class="row" id="sell">
                <div class="col-lg-12 col-12">
                    ...
                    <p>Manak Waste Management Private Limited, a company having its registered office at, Mez & 1st Floor, A-83, Okhla Industrial Area, Okhla Phase II, New Delhi-110020, India (“we”, “our” or “us”) take the security of your personal data very seriously and are committed to protecting and respecting the privacy of the users (“you” or your”) of our Cashify Website and App (the “Platform”).</p>
                    ...
                    <ol class="w-text" style="list-style-type:  inherit;">
                        <li>
                            Visit this website (www.cashify.in) and/or any other CASHIFY website(s) which reference or link to this Statement (collectively, “Website”).
                        </li>
                        ...
                        <li>Receive communications from us, including emails, phone calls, or other electronic messages; or Data we collect.s</li>
                        <br>
                        <p>We collect some information directly from you (for example, via forms you complete or products or Services you access, download, or otherwise obtain). Such information is generally limited to:</p>
                        <ol class="w-text" style="list-style-type:  inherit;">
                            ...
                            <li> Information you provide on the Website, such as online questionnaires, or feedback forms.
                            </li>
                            ...
                            <p>User Registration: In accordance with our contractual obligations or legitimate interest to provide Services, when you register for an account with CASHIFY, we process your Personal Data as needed to register and administer your account, provide technical and client support and training, verify your identity, and send important account, and Services information.</p>
                            ...
                            <p>
                                Contracted Service Providers. As necessary to provide the Services, conduct our business operations, or when we believe that applicable law permits or requires disclosure, we may share Personal Data with contracted service providers, including entities which provide for hosting and system administration, payment processing, analytics, marketing, data enrichment, or client support, to the extent necessary and in accordance with the legal bases set forth above. These service providers only receive Personal Data necessary to fulfill the services they provide to CASHIFY. Under no circumstances are such service providers permitted to use obtained Personal Data for any purpose other than to provide CASHIFY with the designated services.
                            </p>
                            <p>
                                <strong> Employer:</strong> To the extent you are an authorized user of the Services or have otherwise registered for CASHIFY offerings using your corporate email address, we may share Personal Data with your employer to the extent this is necessary to provide you with access, to verify accounts and activity, investigate suspicious activity, or enforce our terms and policies.
                            </p>

                            <strong>
                                <p>
                                    Mergers or Acquisitions:
                            </strong> In the event of a merger, acquisition, consolidation, change of control, corporate divestiture or dissolution where we sell all or a portion of our business or assets, we will disclose necessary Personal Data and such information will be governed
                            by the privacy policies of acquiring entities. In accordance with applicable laws, we will use reasonable efforts to notify you of any transfer of Personal Data to an unaffiliated third party.
                            </p>
                            <p>
                                <strong> Analytics:</strong> Occasionally, we may share non-personal, anonymized, and statistical data with third-parties for the purpose of helping CASHIFY with such analysis and improvements. CASHIFY may also use anonymous, aggregated utilization data for typical business operations (for example, Governance reporting).
                            </p>
                            <p>
                                <strong> Forums:</strong> If any part of the Website or CASHIFY branded social media sites permit public forum posting, the Personal Data you choose to post, share, upload, or make publicly available may be visible to others. You should never post or share any information
                                that is confidential or about others unless you have permission to do so. We may use information you provide to personalize your experience and to make content recommendations.
                            </p>
                            <p>

                                <strong>Acquaintances: </strong> bear in mind that Cashify cannot control what your friends or acquaintances do with the information you share with them. Once displayed on publicly viewable web pages, information that you share can be collected and used by others. To request removal of your personal information from our blog or community forum, please contact us at info@Cashify.in.
                            </p>
                            <p>
                                In some cases, we may not be able to remove your personal information, in which case we will let you know if we are unable to do so and why. We may also provide a feature allowing you to invite/refer a friend to join Cashify or avail our services. If you provide a friend’s email address to us for this reason, we will use that email address only for the purpose of sending a onetime invitation to your friend. Your friend may contact us at info@Cashify.in to remove their information from our database.
                            </p>
                            <p><strong>
                            ...
                            <p>
                                We are permitted to process your personal data where it is necessary for compliance with our legal obligations. For legal claims, we are permitted to process your personal data where it is necessary to establish, pursue or defend a legal claim.
                            </p>
                            <p><strong>
...
<p>
                                ...
                                Service communications: We communicate with you regarding the Transaction that you have initiated with us.
                                </p><p> 

                                Marketing communications and editorial newsletters: If we have your permission, we may send you materials we think may interest you, such as Cashify new offers and updates. Depending on your marketing preferences, this may be by email or SMS.
                                </p><p> 

                                You can decide not to receive these emails at any time and you may manage your receipt of the same by clicking on the “unsubscribe” or other equivalent link located on the bottom of any emails, or contact us at info@cashify.in
                                </p><p> 
                                Customer Feedback: Sometimes we may contact you for feedback related to your transaction/experience with Cashify.
                                ...
                                Right 7 – A right to withdraw your consent, where we are relying on it to use your personal data (for example, to provide you with promotional messages about our services or products). If you withdraw your consent, we may not be able to provide certain
                                </p><p> <strong>
                                ...
                                If you have any questions or comments regarding this Statement or your information, please contact us at info@cashify.in.
                                </p><p> <strong>
