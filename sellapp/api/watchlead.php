...
if (isset($_REQUEST['mid'])){
    ...
    $touchscreen = mysqli_real_escape_string($con,$_POST['touchscreen']);
    ...
    $charging = mysqli_real_escape_string($con,$_POST['charging']);
    $dc = mysqli_real_escape_string($con,$_POST['dc']);
    $button = mysqli_real_escape_string($con,$_POST['button']);
    $optical = mysqli_real_escape_string($con,$_POST['optical']);
    ...
    $strap = mysqli_real_escape_string($con,$_POST['strap']);
