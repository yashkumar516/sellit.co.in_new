...
function GENERATELOGS_API($DATA,$BLOCK,$flag=0) {
    $file_name = "/var/log/aakarist/mobilelead.txt";
...
GENERATELOGS_API($_POST,"[request data]",1);
if(isset($_REQUEST['vid']) && isset($_REQUEST['bid']) && isset($_REQUEST['mid'])){
    ...
    $user = mysqli_real_escape_string($con,$_POST['uidnew']);
    $wage = 0;
    $formwar = 0;
    $touch = 0 ;
    $sspot = 0;
   ...
   // model questions start
    ...
    // model questions end
//   post data
    $formcall = mysqli_real_escape_string($con,$_POST['callin']);
    $formscreen = mysqli_real_escape_string($con,$_POST['screenin']);
    $formsbody = mysqli_real_escape_string($con,$_POST['bodyin']);
    $formwar = mysqli_real_escape_string($con,$_POST['warin']);
    $formtouch = mysqli_real_escape_string($con,$_POST['touch']);
    $formspot = mysqli_real_escape_string($con,$_POST['spot']);
    $formlines = mysqli_real_escape_string($con,$_POST['lines']);
    $formphysical = mysqli_real_escape_string($con,$_POST['physical']);
    $formdents = mysqli_real_escape_string($con,$_POST['dents']);
    $formside = mysqli_real_escape_string($con,$_POST['side']);
    $formbent = mysqli_real_escape_string($con,$_POST['bent']);
    $formage = mysqli_real_escape_string($con,$_POST['age']);
    $Scratches = mysqli_real_escape_string($con,$_POST['Scratches']);
    //  functional question start
    $copydisplay = mysqli_real_escape_string($con,$_POST['copydisplay']);
    $formfrontcamin = mysqli_real_escape_string($con,$_POST['frontcamin']);
    $formbackcamin = mysqli_real_escape_string($con,$_POST['backcamin']);
    $formvolumein = mysqli_real_escape_string($con,$_POST['volumein']);
    $formfingertouchin = mysqli_real_escape_string($con,$_POST['fingertouchin']);
    $formspeaker = mysqli_real_escape_string($con,$_POST['speakerin']);
    $formchargingin = mysqli_real_escape_string($con,$_POST['chargingin']);
    $formfacein = mysqli_real_escape_string($con,$_POST['facein']);
    $formaudioin = mysqli_real_escape_string($con,$_POST['audioin']);
    $formcamglassin = mysqli_real_escape_string($con,$_POST['camglassin']);
    $formwifiin = mysqli_real_escape_string($con,$_POST['wifiin']);
    $formsilentin = mysqli_real_escape_string($con,$_POST['silentin']);
    $formbattryin = mysqli_real_escape_string($con,$_POST['battryin']);
    $formbluetoothin = mysqli_real_escape_string($con,$_POST['bluetoothin']);
    $formvibratein = mysqli_real_escape_string($con,$_POST['vibratein']);
    $formmicroin = mysqli_real_escape_string($con,$_POST['microin']);
    $powerin = mysqli_real_escape_string($con,$_POST['powerin']);
    $formcharger = mysqli_real_escape_string($con,$_POST['charger']);
