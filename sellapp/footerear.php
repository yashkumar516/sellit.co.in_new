...
<section class="top-selling" style="background-color: #fff;">
    <div class="container top-selling-div">
            ...
            <div class="col-lg-12 col-12 mx-auto">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-8" id="choosebrand">
                        <h1 class="top-sell-heading text-center pb-4"> Top Selling Brands </h1>
                    </div>
                    <div class="col-lg-3 col-2"></div>
                </div>
            </div>
        ...
        <div class="owl-carousel owl-carousel-12 owl-theme col-12">
            <?php
      $selectquery = mysqli_query($con, "SELECT * FROM `subcategory` WHERE `status` = 'active' AND `top` = 'active' AND `category_id` = '4' ");
      while ($artop = mysqli_fetch_assoc($selectquery)) {
      ?>
            <div class="item my-3">
                <a href="oldearpod.php?id=<?php echo $artop['id'];  ?>">
...
<section class="top-selling" style="background-color: #fff;">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-12 col-12 mx-auto">
                <div class="row">
                    <div class="col-lg-3 col-2"></div>
                    <div class="col-lg-6 col-8" id="choosebrand">
                        <h1 class="top-sell-heading text-center pb-4"> Top Selling Earbuds </h1>
                    </div>
                    <div class="col-lg-3 col-2"></div>
                </div>
            </div>
  ...
  <div class="container mb-5"> -->
        <div class="owl-carousel owl-carousel-12 owl-theme col-12">
            <?php
      $selectmodel = mysqli_query($con, "SELECT * FROM `product` WHERE `status` = 'active' AND `best` = 'active' AND `categoryid` = '4'");
      while ($armodel = mysqli_fetch_assoc($selectmodel)) {
      ?>
            <div class="item my-3">
                <a href="earpodsold.php?id=<?php echo $armodel['id'] ?>&&bid=<?php echo $armodel['subcategoryid'] ?>">
                    ...
                    <form action="newsletter.php" method="post">
                        <div class="row search">
                            <div class="input-group col-lg-6 col-8" style="height: 5px;">
                                <input type="number" class="form-control mob-no" style="border-color: #8b99a7;"
                                    placeholder="Enter Mobile Phone" name="newsletter">
                            </div>

                            <div class="text-center col-lg-3 col-2">
                                <button class="btn brand-btn sm-brand" name="newsuser"
                                    style="background-color: #fff;padding:4px; margin-top:8px; padding: 8px; padding-left: 14px; padding-right: 14px; font-size: 15px;">Send
                                    Link<i aria-hidden="true"></i></button>
                            </div>
