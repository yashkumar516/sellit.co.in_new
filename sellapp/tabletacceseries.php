...
include 'include/calculationtablet.php';
        ...
        <div class="row">
            <div class="col-lg-5 px-0" id="selllimg">
                ...
                <div class="device px-3">
                    ...
                    <p id="mobage">Tablet Age</p>
                    <p id="age"><?php echo $watchage ?></p>
                    <p id="watchcondion">Tablet Screen Condition</p>
                    <p id="condition"><?php echo $condition ?></p>
                    <p id="pwatchcondion">Tablet Physical Condition</p>
                    <p id="pcondition"><?php echo $pcondition ?></p>
                    <!-- accesiers start -->
                    <p id="dohave"></p>
                    <p id="charger"></p>
                    <p id="earphone"></p>
                ...
                <div class="row ">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 haveitem-col">
                        ...
                        <label for="toggle1">
                            ...
                            <div class="radi-text">
                                <p class="text-center">Original Charger</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 haveitem-col">
                        ...
                        <label for="toggle2">
                            <img src="assets/images/tablequest/pencil.jpg" class="img-fluid" alt="">
                            <div class="radi-text">
                                <p class="text-center">Original S Pen</p>
                            </div>
                        </label>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 haveitem-col">
                        ...
                        <label for="toggle3">
                            ...
                            <div class="radi-text">
                                <p class="text-center">Original Box</p>
                            </div>
                        </label>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 haveitem-col">
                        ...
                        <label for="toggle4">
                            ...
                            <div class="radi-text">
                                <p class="text-center">Valid Bill</p>
                            </div>
                        </label>
                    </div>
                </div>
                <div class="text-center mt-4">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="copydisplayin" name="touchscreen"
                                value="<?php echo $touchscreen ?>">
                            ...
                            <input type="hidden" id="pconditionin" name="pcondition" value="<?php echo $pcondition ?>">
                            ...
                            <div class="col-11 col-lg-12 mx-auto">
                                <form method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="copydisplayin" name="touchscreen"
                                            value="<?php echo $touchscreen ?>">
                                        <input type="hidden" id="frontcamin" name="battery"
                                            value="<?php echo $battery ?>">
                                        <input type="hidden" id="backcamin" name="wifi" value="<?php echo $wifi ?>">
                                        <input type="hidden" id="volumein" name="speaker"
                                            value="<?php echo $speaker ?>">
                                        <input type="hidden" id="fingertouchin" name="charging"
                                            value="<?php echo $charging ?>">
                                        <input type="hidden" id="speakerin" name="dc" value="<?php echo $dc ?>">
                                        <input type="hidden" id="powerin" name="button" value="<?php echo $button ?>">
                                        <input type="hidden" id="chargingin" name="optical"
                                            value="<?php echo $optical ?>">
                                        <input type="hidden" id="facein" name="bluetooth"
                                            value="<?php echo $bluetooth ?>">
                                        <!-- mobileage start -->
                                        <input type="hidden" id="warin" name="warin" value="<?php echo $war ?>">
                                        <input type="hidden" id="agein" name="age" value="<?php echo $watchage ?>">
                                        <input type="hidden" id="btin" name="bt" value="<?php echo $bt ?>">
                                        <input type="hidden" id="fingerin" name="finger" value="<?php echo $finger ?>">
                                        <input type="hidden" id="gpsin" name="gps" value="<?php echo $gps ?>">
                                        <input type="hidden" id="conditionin" name="condition"
                                            value="<?php echo $condition ?>">
                                        <input type="hidden" id="pconditionin" name="pcondition"
                                            value="<?php echo $pcondition ?>">
...
$(document).ready(function() {
    ...
    $('.acceseries').click(function() {
        ...
        if (charger == "yes") {
            ...
            $('#charger').html(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original Charger"
                );
            $('#chargerin').val(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original Charger"
                );
        ...
        if (earphone == "yes") {
            $('#dohave').html("Do you have the following?");
            $('#earphone').html(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original S Pen"
                );
            $('#earphonein').val(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original S Pen"
                );
        ...
        if (boximei == "yes") {
            $('#dohave').html("Do you have the following?");
            $('#boximei').html(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original Box"
                );
            $('#boximeiin').val(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original Box"
                );
        ...
        if (billimei != null) {
            if (billimei == "yes") {
                $('#dohave').html("Do you have the following?");
                $('#billimei').html(
                    "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Valid Bill"
                    );
                $('#billimeiin').val(
                    "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Valid Bill"
                    );
