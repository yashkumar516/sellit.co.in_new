...
$selectupto = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `tabletquestions` WHERE `product_name` = '$mid' "));
?>
<div class="container-fluid" id="sold">
    <div class="row">
        <div class="col-12 col-lg-7 mx-auto py-5" id="soldpage">
            <h3>Sell Old <span class="sell-title-head"> <?php echo $selectquery['subcategory_name'] ?> </span>Tablet
            </h3>
        </div>
    </div>
    <div class="row pb-5">
            ...
            <div class="row h-10">
                ...
                <div class="col-8 col-lg-6 my-auto offset-lg-1">
                    ...
                    <?php
                     ...
                     ?>
                    <div class="mt-4">
                        <a href="tablet-query.php?mid=<?php echo $mid ?>&&bid=<?php echo $bid ?>">
...
<div class="container py-5">
    <div class="row">
        <div class="col-4 border-right text-center"><img src="assets/images/safe.png" class="img-fluid" alt="">
            <h1 class="featsellit"> Safe &amp; Secure </h1>
        </div>
        <div class="col-4 border-right text-center"><img src="assets/images/instant.png" class="img-fluid" alt="">
            <h1 class="featsellit"> Instant Payment </h1>
        </div>
        <div class="col-4 text-center"><img src="assets/images/bestprice.png" class="img-fluid" alt="">
            <h1 class="featsellit"> Best Price </h1>
        </div>
    </div>
</div>
<div class="container mt-3">
    ...
    <div class="row">
        ...
        <div class="col-9">
            <h6 class="reviwer-name"><?php echo $ar['rname'] ?></h6>
            <h1 class="reviewer-heading"><?php echo $ar['rcity'] ?></h1>
        </div>
        <div class="col-12">
