            ...
            <div class="row shadow py-5">
                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="nav col nav-pills col-lg-12 col-12" id="v-pills-tab" role="tablist"
                        ...
                        <a href="#tab1" class="nav-link square-pill mb-3 mr-3 text-uppercase col-lg-12 " id="vision-tab"
                            data-toggle="pill" role="tab" aria-controls="vision-tab" aria-selected="true">
                            upi
                        </a>
                        <a href="#tab2" class="nav-link square-pill mb-3 text-uppercase mr-3 col-lg-12 "
                            id="mission-tab" data-toggle="pill" role="tab" aria-controls="mission-tab"
                            aria-selected="false">
                            paytm
                        </a>
                    </div>
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="accountno"
                                                ...
                                                value="<?php echo $selectacountdetail['accountno'] ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="conaccountno"
                                                placeholder="Confirm Account no*"
                                                value="<?php echo $selectacountdetail['confirmaccountno'] ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="benefiname"
                            ...
                            <div class="row">
                                <div class="col-lg-11 mx-auto add-form">
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="conaccountno"
                                                placeholder="Confirm Account no*" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="benefiname"
