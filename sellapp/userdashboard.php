            ...
            <div class="row shadow py-5">
                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="nav col nav-pills col-lg-12 col-12" id="v-pills-tab" role="tablist"
                        ...
                        <a href="#tab3" class="nav-link square-pill mb-3 text-uppercase mr-3 col-lg-12 active show"
                        ...
                        <a href="#tab1" class="nav-link square-pill mb-3 mr-3 text-uppercase col-lg-12" id="vision-tab"
                            data-toggle="pill" role="tab" aria-controls="vision-tab" aria-selected="false">
                            saved address
                        </a>
                        <a href="#tab2" class="nav-link square-pill mb-3 text-uppercase mr-3 col-lg-12" id="mission-tab"
                            data-toggle="pill" role="tab" aria-controls="mission-tab" aria-selected="false">
                            account details
                        </a>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-12 tab-content-detail mb-2">
                   ...
                   ?>
                                <div class="col-lg-11 userdash mb-2">
                                    ...
                                    <p class="mb-1"><b>Beneficiarname:</b> <?php echo $selectacc['beneficiarname'] ?>
                                    </p>
                   ...
                   ?>
                                <div class="col-lg-11 userdash mb-2">
                                    <div class="row">
                                        <div class="col-7">
                                            <p class="mb-1"><b>Date:</b>
                                                <?php echo date('d/m/y',strtotime($arenq['modify_date']))  ?> </p>
