<footer class="footer-color">
    <div class="col-lg-10 col-md-10 col-sm-12 col-11 mx-auto footer-details">
        ...
        <div class="d-flex justify-content-center">
            <a href="index.php"> <img src="assets/images/footer-logo2.png" alt=""></a>
        </div>
        <div class="d-flex justify-content-center">
            <a href="index.php"> <img src="assets/images/footer-text1.png" alt=""></a>
        </div>
            ...
            <a href=""><li>careers</li></a>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="footer-social-icon">
                        <a href="twitter.com/sellit.co.in"><img src="assets/images/1.png" class="px-1" alt="twitter"
                                width="17%"></a>
                        <a href=""><img src="assets/images/2.png" class="px-1" alt="inbox" width="17%"></a>
                        <a href="facebook.com/sellit.co.in"><img src="assets/images/3.png" class="px-1" alt="facebook"
                                width="17%"></a>
                        <a href="instagram.com/sellit.co.in"><img src="assets/images/4.png" class="px-1" alt="instagram"
                                width="17%"></a>
                    </div>
                </div>
