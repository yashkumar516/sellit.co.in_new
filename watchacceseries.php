...
$(document).ready(function() {
    ...
    $('.acceseries').click(function() {
        ...
        if (earphone == "yes") {
            $('#dohave').html("Do you have the following?");
            $('#earphone').html(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>strap"
                );
            $('#earphonein').val(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>strap"
                );
        ...
        if (boximei == "yes") {
            $('#dohave').html("Do you have the following?");
            $('#boximei').html(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Box"
                );
            $('#boximeiin').val(
                "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Box"
                );
        ...
        if (billimei != null) {
            if (billimei == "yes") {
                $('#dohave').html("Do you have the following?");
                $('#billimei').html(
                    "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Bill"
                    );
                $('#billimeiin').val(
                    "<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Bill"
                    );
