...
<section class="top-selling" style="background-color: #fff;">
    <div class="container top-selling-div">
        ...
        <div class="owl-carousel owl-carousel-12 owl-theme col-12">
            <?php
      $queryBrand = mysqli_query($con, "SELECT * FROM `subcategory` WHERE `status` = 'active' AND `top` = 'active' AND `category_id` = '4' ");
      while ($brandData = mysqli_fetch_assoc($queryBrand)) {
      ?>
            <div class="item my-3">
                <a href="oldearpod.php?id=<?php echo $brandData['id'];  ?>">
...
<section class="top-selling" style="background-color: #fff;">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-12 col-12 mx-auto">
                <div class="row">
                    <div class="col-lg-3 col-2"></div>
                    <div class="col-lg-6 col-8" id="choosebrand">
                        <h3 class="top-sell-heading text-center pb-4"> Top Selling Earbuds </h3>
                    </div>
                    <div class="col-lg-3 col-2"></div>
                </div>
            </div>
  ...
  <div class="container mb-5"> -->
      ...
      ?>
            <div class="item my-3">
                <a
                    href="earpodsold.php?id=<?php echo $modelData['id'] ?>&&bid=<?php echo $modelData['subcategoryid'] ?>">
