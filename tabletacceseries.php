   ...
   <div class="col-12 col-lg-12 mx-auto my-auto text-center p-5 img-responsive">
    ...
    <input type="hidden" id="callin" name="switch" value="<?php echo $switch ?>">
		    ...
		    <input type="text" class="form-control py-2 px-2 my-3 loginuser" name="name" id="name" placeholder=" Enter your Name" required>
                     <input type="email" class="form-control py-2 px-2 my-3 loginuser" name="email" id="name" placeholder=" Enter your Email" required>
 ...
 $(document).ready(function() {
    ...
    $('.acceseries').click(function() {
      var charger = $("input[type=checkbox][name=charger]:checked").val();
        ...
        {
            $('#dohave').html("Do you have the following?");
            $('#earphone').html("<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original S Pen");
            $('#earphonein').val("<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original S Pen");
        }
        else{
            $('#dohave').html("Do you have the following?");
            $('#earphone').html("");
        ...
        {
            $('#dohave').html("Do you have the following?");
            $('#boximei').html("<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original Box");
            $('#boximeiin').val("<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Original Box");
        }
        else{
            $('#dohave').html("Do you have the following?");
            $('#boximei').html("");
        ...
        {    
            $('#dohave').html("Do you have the following?");
            $('#billimei').html("<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Valid Bill");
            $('#billimeiin').val("<i class='fas fa-dot-circle' style='font-size:10px;margin-right:12px;color:#1B6C9E;' ></i>Valid Bill");   
